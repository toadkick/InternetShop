...
alter table products add CONSTRAINT FK_Parent foreign key (parent_id) references PRODUCTS (product_id) on delete set null;;
alter table category add CONSTRAINT FK_Category2 foreign key (parent_category_id) references category (category_id) on delete set null;;
...
insert into products values(4,12,'The Magic Mountain','T.Mann',null,200,10,2010,'1.jpg');
insert into products values(5,12,'The Silver Dove','A.Bely',null,50,15,2011,'2.jpg');
insert into products values(6,2,'The Dark Tower: The Gunslinger','S.King',null,100,8,2001,'3.jpg');
insert into products values(7,2,'The Dark Tower II: The Drawing of the Three','S.King',6,110,7,2001,'1.jpg');
insert into products values(8,21,'Elric of Melnibone','M.Moorcock',null,450,2,1995,'2.jpg');
insert into products values(9,22,'The Time Machine','H.Wells',null,90,9,2010,'3.jpg');
insert into products values(10,22,'Stranger in a Strange Land','R.A.Heinlein',null,120,5,2015,'1.jpg');
